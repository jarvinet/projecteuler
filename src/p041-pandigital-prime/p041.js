...
var permutations = permutator([7,6,5,4,3,2,1]);

permutations.forEach(function(permutation) {
//    console.log("permutation", permutation);
    var numberAsString = permutation.reduce(function(accumulator, currentValue, currentIndex, array) {
        return accumulator + currentValue;
    }, "");
//    console.log("numberAsString", numberAsString);
    var numberAsInt = new Number(numberAsString);
//    console.log("numberAsInt", numberAsInt);
    console.log("isPrime", isPrime2(numberAsInt), numberAsInt);
});
